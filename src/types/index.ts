...
export type KnownChromeMessageType =
  ...
  | 'simulcast:getStatus'
  | 'simulcast:update'
  | 'simulcast:updatePlayback'
  | 'simulcast:strictPlayerDelay'
  | 'simulcast:popupUpdate'
  | 'simulcast:offscreenStart'
  | 'simulcast:offscreenStop'
  | 'simulcast:offscreenUpdatePlayback'
  | 'simulcast:offscreenStrictPlayerDelay'
  | 'simulcast:syncVideo'
  | 'simulcast:videoPlaying'
  | 'simulcast:videoStopped'
  | 'simulcast:queryVideoPlaying'
  | 'simulcast:subtitle'
  | 'simulcast:videoClock'
  | 'simulcast:dynamicVideoSync'
